...
### Arroyo activity assets — September 20–21

Five original editable Blender props, the generated transparent start-paint input and the board lettering source are documented in [activity provenance](activity-PROVENANCE.md). Sixteen original synthesized sound exports retain their recipes and licensing in the audio source records. The merge retains the newer main neighborhood, character, coupe, terrain and canopy assets; its static reflection atlas was rebaked for the combined scene.
