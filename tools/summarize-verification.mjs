...
const sourceFiles = [
  ...
  "apps/browser/src/canopy-lighting.ts",
  ...
  "tools/assets/canopy-visibility.py", "tools/assets/canopy-visibility.mjs",
  "assets/source/canopy-base/base.json",
  "assets/source/canopy-base/tree.blend", "assets/source/canopy-base/tree.glb",
  "assets/source/canopy-base/roadside-oak.blend", "assets/source/canopy-base/roadside-oak.glb",
