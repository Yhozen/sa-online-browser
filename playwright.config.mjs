...
import { acceptanceConnectOptions, acceptanceLaunchOptions } from './tools/browser-options.mjs';
export default defineConfig({
  ...
  use: { headless: process.env.POC_HEADLESS === '1', viewport: { width: 1440, height: 960 },
    launchOptions: acceptanceLaunchOptions(), connectOptions: acceptanceConnectOptions(),
  },
});
